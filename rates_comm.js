...
window.RATES = {
  ...
  window.MIN_ICR = { Fix: 1.25, Tracker: 1.3 };
  window.MIN_LOAN = 75000;
  window.MAX_LOAN = 1500000;
  window.STANDARD_BBR = 0.0425;
  window.STRESS_BBR = 0.045;
  window.REVERT_RATE = { "Tier 1": { add: 0.003 }, "Tier 2": { add: 0.015 } };
  window.ERC = {
  ...
  window.MIN_ICR_Commercial = { Fix: 1.25, Tracker: 1.3 };

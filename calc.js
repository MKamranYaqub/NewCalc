    ...
    function App() {
      ...
      const getCurrentCriteria = () => {
        if (propertyType === "Commercial" || propertyType === "Semi-Commercial") {
          return window.CRITERIA_CONFIG?.Commercial || window.CRITERIA_CONFIG?.Residential;
        }
      ...
      const [criteria, setCriteria] = useState(() => initializeCriteriaState(getCurrentCriteria()));

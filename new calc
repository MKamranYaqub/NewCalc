(function(){
  ...
  window.__AppResidential=AppResidential;
  })();
  ...
  window.__AppCommercial=AppCommercial;
  })();
  
  
  /* === Unified Wrapper: choose Residential / Commercial (Semi-Commercial = Commercial) === */
  function UnifiedApp() {
    ...
    return (
      <div>
        ...
        {category === "Residential" ? <window.__AppResidential /> : <window.__AppCommercial />}
      </div>
    );
  }
